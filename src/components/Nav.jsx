        ...
        <div className="flex items-center justify-between gap-1 py-4 md:py-5">
              ...
              return (
                ...
                >
                  <Link
                    to={item.path}
                    className="relative text-lg font-bold whitespace-nowrap text-[color:var(--foreground)] hover:text-[color:var(--variable-collection-primary)] transition"
                    onFocus={() => hasDropdown && setOpenIndex(idx)}
                    onBlur={() => hasDropdown && setOpenIndex(null)}
                  ...
                  {hasDropdown && isOpen && (
                    <div className="absolute top-full left-0 mt-2 w-56 rounded-md bg-white shadow-lg ring-1 ring-black/5 z-50">
                      <ul className="py-1" role="menu" aria-label={`${item.label} submenu`}>
                        {item.dropdown.map((sub) => (
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <form
              ...
              className="flex items-center bg-white rounded-[20px] shadow-[0_2px_2px_rgba(0,0,0,0.25)] px-3 py-2"
              role="search"
            >
              <button
                type="submit"
                ...
                className="mr-2"
              >
                <img src="/images/search.svg" alt="" className="w-8 h-8" />
              </button>
              <input
                type="search"
                placeholder="Search"
            ...
            <Link
              ...
              className="w-9 h-9 rounded hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[color:var(--variable-collection-primary)]"
            >
              <img src="/images/heart.svg" alt="" className="w-full h-full object-contain" />
            </Link>
            ...
            <Link
              ...
              className="w-9 h-9 rounded hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[color:var(--variable-collection-primary)]"
            >
              <img src="/images/person.svg" alt="" className="w-full h-full object-contain" />
            </Link>
            ...
            <Link
              ...
              className="w-9 h-9 rounded hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[color:var(--variable-collection-primary)] relative"
            >
              <img src="/images/cart.svg" alt="" className="w-full h-full object-contain" />
              <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full px-1">
                {cartCount}
              </span>
            </Link>
